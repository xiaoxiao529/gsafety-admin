      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="企业ID" prop="orgCode" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="防火巡查任务号数" prop="planNo" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="防火巡查人物名" prop="planName" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="巡查人" prop="patrolPeople" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="周期" prop="cycle" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="开始时间" prop="taskStartTime" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="结束时间" prop="taskEndTime" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
  ...
  export default {
    ...
    methods: {
      ...
      actualUsersPage() {
        ...
        that.$axios
          .$POST_CENTER({
            api_name: "getFirePatrolYesterday",
            params: {
        ...
        getExcelUrl(){
            let url = "/center/" + ApiConfig.api["getFirePatrolYesterday"]+"Excel";
