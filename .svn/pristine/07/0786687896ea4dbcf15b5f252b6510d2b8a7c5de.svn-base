      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="报警数" prop="alarmNumber" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      actualUsersPage() {
        ...
        that.$axios
          .$POST_CENTER({
            api_name: "getAlarmDataOfService",
            params: {
      ...
      getExcelUrl(){
          let url = "/center/" + ApiConfig.api["getAlarmDataOfService"]+"Excel";
