      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="二次码" prop="two_code" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      actualUsersPage() {
        ...
        that.$axios
          .$POST_CENTER({
            api_name: "jkgetFireAlarmDetails",
            params: {
        ...
        getExcelUrl(){
            let url = "/center/" + ApiConfig.api["jkgetFireAlarmDetails"]+"Excel";
