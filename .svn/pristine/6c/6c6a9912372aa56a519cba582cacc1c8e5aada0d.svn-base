      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="业主单位" prop="unitName" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="业主单位服务模式" prop="serviceMode" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="是否是新增企业" prop="isNew" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="登录名" prop="loginName" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="用户名" prop="userName" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="注册时间" prop="registerDate" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getExcelUrl(){
          let url = "/center/" + ApiConfig.api["newUserInNewCompany"]+"Excel";
