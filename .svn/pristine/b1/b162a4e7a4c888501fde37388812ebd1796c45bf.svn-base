      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="运营中心" prop="orgName" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="企业名称" prop="unitName" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="用户名称" prop="name" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
