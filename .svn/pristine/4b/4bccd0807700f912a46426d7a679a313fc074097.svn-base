          ...
          <div class="main-container">
            ...
            <el-form :inline="true" :model="formData" ref="formData" class="hardware-form">
              ...
              <el-form-item class="el_form_item" label=" " prop="serverModelName" :label-width="labelWidth">
                <el-select placeholder="服务模式"
                           multiple collapse-tags filterable clearable
                           v-model.trim="formData.serviceModel" >
                  <el-option
        ...
        <div class="echarts-item-wrapper">
          ...
          <div class="list-wrap">
            <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
              ...
              <el-table-column label="服务模式" prop="serverModelName" show-overflow-tooltip align="center"></el-table-column>
              <el-table-column label="新增企业数" prop="amount" show-overflow-tooltip align="center"></el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            findMonitorDeviceStateDownList() {
                ...
                this.$axios
                    .$GET_ENTER({
                        api_name: "findNewCompanyTable",
                        params: {
                            orgCode: this.formData.orgCode===undefined?"":this.formData.orgCode.toString(),
            ...
            exportExcel() {
                ...
                let url = defaults + ApiConfig.api["downloadNewCompanyExcel"]+
