      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="运营中心名称" prop="orgName" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="历史企业数" prop="companyNumHistory" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="历史用户数" prop="userNumHistory" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="当月新增企业数" prop="companyNumThisMonth" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="当月新增用户数" prop="userNumThisMonth" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="昨日新增企业数" prop="companyNumYesterday" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="昨日新增用户数" prop="userNumYesterday" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getExcelUrl(){
          let url = "/center/" + ApiConfig.api["businessActivity"]+"Excel";
