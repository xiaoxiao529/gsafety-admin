      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="机构用户数" prop="orgUserNum" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="注册用户数" prop="registerUserNum" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
          </el-table>
          <Pagination
  ...
  export default {
    ...
    methods: {
      actualUsersPage() {
        ...
        that.$axios
          .$POST_CENTER({
            api_name: "getRegiAndSysUserNumberYesterday",
            params: {
        ...
        getExcelUrl(){
            let url = "/center/" + ApiConfig.api["getRegiAndSysUserNumberYesterday"]+"Excel";
