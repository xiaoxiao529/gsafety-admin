      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="运营中心侧" prop="serviceCenterUserNum" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="企业侧" prop="fireUserNum" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="维保侧" prop="maintenanceUserNum" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="用户总数" prop="toalUserNum" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getExcelUrl(){
          let url = "/center/" + ApiConfig.api["getFullData"]+"Excel";
