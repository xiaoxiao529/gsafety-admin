      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="企业名称" prop="orgName" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="企业ID" prop="deviceName" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="防火巡查任务号数" prop="deviceId" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="防火巡查人物名" prop="model" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="巡查人" prop="brand" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="周期" prop="deviceAddress" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="开始时间" prop="controlHost" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="结束时间" prop="offlineStateTime" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
  ...
  export default {
    ...
    methods: {
      ...
      actualUsersPage() {
        ...
        that.$axios
          .$POST_CENTER({
            api_name: "getFireCheckYesterday",
            params: {
        ...
        getExcelUrl(){
            let url = "/center/" + ApiConfig.api["getFireCheckYesterday"]+"Excel";
