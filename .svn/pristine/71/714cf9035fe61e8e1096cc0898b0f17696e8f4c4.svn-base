 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2019-08-05 11:41:53
 -->
<template>
  <div>
    <div class="Crumbs">
    ...
    <div class="main-wrap">
      ...
      <div class="main-container">
        <div class="enterpriserUser-wrap" v-loading.lock="isLoading">
          <div class="left-tree">
          ...
          <div class="right-con">
            <div class="list-wrap">
              <el-table :data="tableData" show-overflow-tooltip stripe @row-click="detail">
                <el-table-column
                  label="用户名"
                  prop="loginName"
    ...
    getTableData() {
      ...
      that.$axios
        .$POST_NEW({
          ...
          params: {
            centerType: 3, //1 总中心2：运营中心 3：业主单位 4：服务机构
      ...
      that.$axios
        .$POST_NEW({
          ...
          params: {
            ...
            orgCode: row.orgCode,
            operateType: operateType //操作类型(1:解锁 2:锁定)
          }
        })
        .then(res => {
          if (res.data.code == "success") {
          ...
          that.$axios
            .$POST_NEW({
              ...
              params: {
                ...
                orgCode: that.orgCode || that.currentOrgcode,
                postCodes: that.createAdminForm.postCodes
              }
            })
            .then(res => {
              if (res.data.code == "success") {
