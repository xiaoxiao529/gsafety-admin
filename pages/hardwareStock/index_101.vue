      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          ...
          >
            ...
            <el-table-column label="序列号"  show-overflow-tooltip min-width="6%">
              <template slot-scope="scope">
                <div class="stock-p-wrap">{{scope.row.serialNumber || '--'}}</div>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" align="center" min-width="10%" class="set-wrapper">
              <template slot-scope="scope">
