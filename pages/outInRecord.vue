 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2019-07-15 10:12:51
 -->
    ...
    <div class="main-wrap">
      ...
      <div class="main-container">
        ...
        <el-form :inline="true" :model="serchForm" ref="serchForm" class="hardware-form">
          ...
          <el-form-item class="item-DataSelect" label="操作时间:" prop="time" :label-width="labelWidth">
            <el-date-picker
          ...
          <el-form-item class="serch-btn" label style>
