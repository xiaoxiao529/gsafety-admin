      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="通话开始时间" prop="beginTime" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="通话结束时间" prop="endTime" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
  ...
  export default {
    ...
    methods: {
      actualUsersPage() {
        ...
        getExcelUrl(){
            let url = "/center/" + ApiConfig.api["getCallTimeDetails"]+"Excel";
