      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="消防设备类型" prop="deviceType" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="监测位号" prop="makePoint" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="报警时间" prop="alarmTime" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="报警时长" prop="difMinute" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="警情状态" prop="alarmState" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="是否规范" prop="isRegular" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="反馈人" prop="feedbackPerson" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="反馈时间" prop="feedbackTime" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getExcelUrl(){
          let url = "/center/" + ApiConfig.api["getAlarmCheck"]+"Excel";
