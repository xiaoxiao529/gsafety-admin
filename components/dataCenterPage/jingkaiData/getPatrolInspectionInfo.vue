      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="企业ID" prop="companyId" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            ...
            <el-table-column label="值班人" prop="dutyUser" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="是否规范" prop="standardStatus" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
  ...
  export default {
    ...
    methods: {
      ...
      actualUsersPage() {
        ...
        that.$axios
          .$POST_CENTER({
            api_name: "getPatrolInspectionInfo",
            params: {
        ...
        getExcelUrl(){
            let url = "/center/" + ApiConfig.api["getPatrolInspectionInfo"]+"Excel";
