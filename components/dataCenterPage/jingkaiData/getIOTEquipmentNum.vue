      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="单位ID" prop="unitId" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="物联网设备数量" prop="equipmentNum" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
  ...
  export default {
    ...
    methods: {
      ...
      actualUsersPage() {
        ...
        getExcelUrl(){
            let url = "/center/" + ApiConfig.api["getIOTEquipmentNum"]+"Excel";
