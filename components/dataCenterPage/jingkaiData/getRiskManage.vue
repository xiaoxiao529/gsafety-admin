      ...
      <div class="main-container">
        ...
        <div class="list-wrap">
          <el-table v-loading.lock="isLoading" :data="tableData" stripe show-overflow-tooltip>
            ...
            <el-table-column label="位置" prop="deviceAddress" align="center" show-overflow-tooltip min-width="12%"></el-table-column>
            <el-table-column label="上报途径" prop="reportChannel" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="故障位号" prop="makeLoopPoint" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="隐患时间" prop="troubleTime" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="整改时间" prop="rectificationDate" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="处理状态" prop="dealState" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
            <el-table-column label="是否逾期" prop="isOverdued" align="center" show-overflow-tooltip min-width="8%"></el-table-column>
          </el-table>
          <Pagination
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getExcelUrl(){
          let url = "/center/" + ApiConfig.api["getRiskManage"]+"Excel";
